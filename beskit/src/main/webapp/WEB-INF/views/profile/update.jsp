...
<script>
	...
	window.onload = function() {
		...
		$.ajax({
			...
			if(articleVO.art_pic != null) {
				$('#pic_input').html('<img src="<c:url value="' + articleVO.art_pic + '"/>"/>' +
	...
	$(function() {
		...
		$('#picDeleteBtn').click(function() {
			if(confirm('<fmt:message key="upload.delPicMsg"/>')) {
				$('#pic_input').html('<img src="<c:url value="/resources/img/article/img_noimage.png"/>"/>' +
				'<input type="hidden" id="art_pic" value=""/>');
			}
		});
	...
	//수정을 클릭 시
	function submitBtn() {
		if(confirm('<fmt:message key="upload.modArtMsg"/>')) {
			$(function() {	
...
<table align="center">
	<caption><fmt:message key="upload.modTitle"/></caption>
<tr>
	<td align="center">
...
<tr>
	<td align="center">
		<input type="button" value="<fmt:message key="upload.picChange"/>" id="picChangeBtn"/>
		<input type="button" value="<fmt:message key="upload.picDelete"/>" id="picDeleteBtn"/>
	</td>
</tr>
<tr>
	<td align="center">
...
<tr>
	<td align="center">
		<input type="button" value="<fmt:message key="upload.modify"/>" onclick="javascript:submitBtn();"/>
		<input type="reset" value="<fmt:message key="upload.delContent"/>"/>
		<input type="button" value="<fmt:message key="upload.cancel"/>" onclick="javascript:cancelBtn();"/>
	</td>
</tr>
</table>
</form>
