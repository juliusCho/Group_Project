...
@Component
@Scope("prototype")
public class ListSquareDivision implements Serializable {
	...
	public List<ArticleVO> listArticle(long mem_no, int moreArtBtnNo, int mem_country) throws Exception {
		this.mem_no = mem_no;
		...
		setArtList(squareService.listArticle(memberVO));			
	...
	public List<CommentVO> listComment(long art_no, int moreComBtnNo) throws Exception {
		...
		setComList(squareService.listComment(art_no));			
	...
	public String toString() {
		return "ListSquareDivision [squareService=" + squareService + ", displayArtNumber=" + displayArtNumber
