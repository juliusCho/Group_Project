...
function erro_naver(){
		alert("naver에서 인증 처리중입니다.");
	};
	
function erro_face(){
		alert("facebook에서 인증 처리중입니다.");
	};
</script>
</head>
<body>
	...
	<div id = "main_body">	
		...
		<div id="body_02">
			<table id="login">
					...
					<td colspan="3" align="center">
						<table id="logout_table">
							<tr>
								...
								<c:choose>
									<c:when test="${memberInfo.mem_pic eq null || memberInfo.mem_pic eq ''}">
								...
								<td align="center" width="150" >
									...
									<br/><br/>
									<a id="my_logout" href="/sjl/member/logout"><fmt:message key="login.logout"/></a>
								</td>
							</tr>
						</table>
					</td>
				...
				<tr>
					<td colspan="3" id="membership">
						<a href="<c:url value="/article/${sessionScope.memberInfo.mem_no}/"/>" ><img src="<c:url value="/resources/img/main/sub_00.jpg"/>"></a>
					</td>
				</tr>
				</c:if>
				</form>
				<tr>
					<td colspan="3" id="membership">
						<a onclick="location.href='javascript:erro_naver();'" ><img src="<c:url value="/resources/img/main/sub_02.jpg"/>"></a>
					</td>
				<tr>
					<td colspan="3" id="membership">
						<a onclick="location.href='javascript:erro_face();'" ><img src="<c:url value="/resources/img/main/sub_03.jpg"/>"></a>
					</td>
				</tr>
			</table>
		</div>
