...
@Component
@Scope("prototype")
public class ListProfileDivision implements Serializable {
	...
	public List<ArticleVO> listArticle(long mem_no, int moreArtBtnNo) throws Exception {
		...
		setArtList(profileService.listArticle(mem_no));			
	...
	public List<CommentVO> listComment(long art_no, int moreComBtnNo) throws Exception {
		...
		setComList(profileService.listComment(art_no));			
	...
	public String toString() {
		return "ListProfileDivision [profileService=" + profileService + ", displayArtNumber=" + displayArtNumber
